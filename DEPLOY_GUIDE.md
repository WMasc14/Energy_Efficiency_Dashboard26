...
5. O Render detectará o arquivo `render.yaml` e usará a configuração automática
6. Confirme o serviço e inicie o deploy

**Configuração interna do Render:**
- **Build Command:** `pip install -r requirements.txt && npm install && npm run build`
- **Start Command:** `uvicorn main:app --host 0.0.0.0 --port $PORT`
- **Branch:** `master`
- **Auto Deploy:** habilitado via `render.yaml`

**Vantagens:** Gratuito, fácil, autodeploy no push

> O Render irá rodar o backend FastAPI e servir o frontend React compilado em `dist/`.
